<?php  include_once 'head.php';
    ...
    if(isset($_GET['courseId'])){
      ...
      //? delete user account
      $sql=$conn->query("DELETE FROM `createcourse` WHERE courseId='$courseId'");
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a href="./edit.php?courseId=<?= $row['courseId']; ?>&status=edit" class="dropdown-item" href="javascript:void(0);"
