        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <?php  $id = $_GET['questionsId'];
		$sql= $conn->query(" SELECT * FROM `past-questions` WHERE questionsId='$id' ");
		if($sql->num_rows>0){
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <small class="text-muted float-end">Course Id #<?php echo $row['questionsId'];   ?></small>
                    </div>
                    <div class="card-body">
                      <form action="edit-questions.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="questionsId" value="<?php echo $row['questionsId'] ?>">
                        ...
                        <button type="button" href="" name="update_question" class="btn btn-primary">Update</button>
                      </form>
                    </div>
                  </div>
                </div>
