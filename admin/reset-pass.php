...
if (isset($_GET['reset'])) {
	...
	if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `admin`  WHERE code ='{$_GET['reset']}' ")) > 0) {
		if (isset($_POST['SaveNewPass'])) {
			...
			$cpass = md5(cleaninput($_POST['cpass']));
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="reset-pass.php" method="GET">
                  
                  <div class="mb-3 form-password-toggle">
                      <div class="d-flex justify-content-between">
                          <label class="form-label" for="password">New Password</label>
                        </div>
                        <span class="text-danger"><?php echo isset($passErr)? $emailErr: ""?></span>
                ...
                <div class="mb-3">
                  <button name="SaveNewPass" class="btn btn-primary d-grid w-100" type="submit">Submit</button>
                </div>
              </form>
