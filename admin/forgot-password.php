<?php  include_once 'head.php';
   ...
   require 'vendor/autoload.php';
       ...
       if(isset($_POST['resetPass'])){ 
        ...
        // print_r($_POST['email']);
        // die;
    if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `admin` WHERE email= '$email'"))){
      ...
      //  echo "<div style='display: none';>";
       ...
       try {
           ...
           $mail->Username   = 'davidaniago@gmail.com';                     //SMTP username
           $mail->Password   = 'dave...357';                               //SMTP password
           $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
           $mail->Port       = 465;                                    //TCP port  to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
       
           //Recipients
           $mail->setFrom('davidaniago@gmail.com');
           ...
           $code = cleaninput(md5(rand(90876, 34576)));
           $mail->Body    = 'Here is your password reset Link <b><a href="http://localhost/educa/admin/reset-pass.php?reset='.$code.'">http://localhost/educa/admin/reset-pass.php?reset='.$code.'</a></b>';;
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">weLearn</span>
                </a>
              </div>
              <!-- /Logo -->
