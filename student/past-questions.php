  ...
  <body>
    ...
    <?php  include_once 'sidebar.php';?>
		...
		if($sql->num_rows>0){
              ...
              <img src="../admin/<?php echo $row['profile']; ?>" alt class="w-px-40 w-100  h-100  rounded-circle" />                  
              </div>  
                          </div>
                          <div class="col-sm-6">
                  ...
                  <div class="row text-center">
                    <div class="col-md-12">
                      <a type="a" href="view-course.php?questionsId=<?= $row['questionsId']; ?>&status=view" class="btn btn-outline-primary">View Course</a>
        </div>
                      </div>
                        </div>
                    </div>
