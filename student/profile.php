              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <input type="hidden" name="studentsId" value="<?php echo $row['studentsId'] ?>" >
                    <?php  $studentsId=$_SESSION['studentsId'];
							$sql= $conn->query(" SELECT * FROM student WHERE studentsId='$studentsId'");
							if($sql->num_rows>0){
 ...
 ?>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <?php  if(isset($_GET['studentsId']) ){
                        $studentsId= $_GET['studentsId'];
                       
                        if($_GET['status']=='delete'){
                        //? delete user account
                        $sql=$conn->query("DELETE FROM `student` WHERE studentsId='$studentsId' ");
                        ?> <script>
                     ...
                     ?>
                      <form id="formAccountDeactivation"  action="profile.php"  >
                        ...
                        <input type="hidden" value="<?php echo $row["studentsId"] ?>">
                        ...
                        <a href="profile.php?studentsId=<?php echo $row['studentsId'];?>&status=delete" class="btn btn-danger deactivate-account">Deactivate Account</a>
                      </form>
                    </div>
                  </div>
                </div>
